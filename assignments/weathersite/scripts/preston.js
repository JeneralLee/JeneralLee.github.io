...
/*    document.getElementById("weatherdescription").innerHTML = currentTemp.list[0].weather[1].main;
...
/*   document.getElementById("humidity").innerHTML = currentTemp.list[0].main.humidity; 
   document.getElementById("precipitation").innerHTML = currentTemp.list[0].main.precipitation; */
...
/*  document.getElementById("").innerHTML = */
  console.log(forecastRequest.response);
